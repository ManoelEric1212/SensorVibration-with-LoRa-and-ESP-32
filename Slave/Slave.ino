...
void read_sensor(){
  ...
  Serial.print(" | AcZ = "); Serial.print(AcZ / 2048.0);Serial.print(":::");
  Serial.print(max_acx);Serial.print(";"); Serial.print(max_acy);Serial.print(";"); Serial.print(max_acz);
  Serial.print(":::");Serial.print(min_acx);Serial.print(";"); Serial.print(min_acy);Serial.print(";"); Serial.print(min_acz);Serial.print(":::");
  Serial.print(abs(max_acx));Serial.print(";"); Serial.print(abs(max_acy));Serial.print(";"); Serial.println(abs(max_acz));
...
void loraSentPacket_data(){
  ...
  LoRa.print(AcX);LoRa.print("|");LoRa.print(AcY);
  LoRa.print("|");LoRa.print(AcZ);LoRa.print("|");
  LoRa.print(indica_normal);LoRa.print("|");LoRa.print(indica_disturbio1);LoRa.print("|");
  LoRa.print(String(id_equip[0])+String(id_equip[1])+"-"+String(id_equip[2])+String(id_equip[3])+String(id_equip[4])+String(id_equip[5])+"-"+String(id_equip[6])+String(id_equip[7])+String(id_equip[8]));LoRa.print("|");
